	...
	include('assets/inc/config.php');
		if(isset($_POST['update_profile']))
		{
           ...
           // $doc_pwd=sha1(md5($_POST['doc_pwd']));
			...
			$query="UPDATE his_docs SET doc_fname=?, doc_lname=?,  doc_email=?, doc_dpic=? , téléphone =?WHERE doc_id = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssi', $doc_fname, $doc_lname, $doc_email, $doc_dpic, $doc_id , $téléphone);
			$stmt->execute();
			/*
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="firstname">Numéro de téléphone</label>
                                                                <input type="text" name="téléphone"  class="form-control" id="firstname" placeholder="<?php echo $row->téléphone;?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="text-right">
                                                        <button type="submit" name="update_profile" class="btn btn-success waves-effect waves-light mt-2"><i class="mdi mdi-content-save"></i> Eregistrer</button>
                                                    </div>
                                                </form>
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" class="form-control" id="firstname" placeholder="Enterz votre ancien mot de passe">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="lastname">Nouveau mot de passe </label>
                                                                <input type="password" class="form-control" name="doc_pwd" id="lastname" placeholder="Enterez un nouveau mot de passe">
                                                            </div>
                                                        </div> <!-- end col -->
                                                    </div> <!-- end row -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control" id="useremail" placeholder="Confirmez le nouveau mot de passe">
                                                    </div>

                                                    <div class="text-right">
                                                        <button type="submit" name="update_pwd" class="btn btn-success waves-effect waves-light mt-2"><i class="mdi mdi-content-save"></i> Enregistrer</button>
                                                    </div>
                                                </form>
                                            </div>
