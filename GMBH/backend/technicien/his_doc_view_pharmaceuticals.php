                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT * FROM  his_pharmaceuticals where matricule='$doc_number'  "; 
                                                $stmt= $mysqli->prepare($ret) ;
                                                $stmt->execute() ;//ok
                                                $res=$stmt->get_result();
                                                $cnt=1;
                                            ...
                                            ?>
                                                ...
                                                <td><?php echo $row->id;?></td>
                                                    ...
                                                    <td><a href="his_admin_view_single_pharm.php?id=<?php echo $row->id;?>" class="badge badge-success"><i class="far fa-eye "></i> Voir</a></td>
                                                    <td><a href="etat.php?id=<?php echo $row->id;?>" class="badge badge-success"><i class="fas fa-edit"></i> Préciser l'étape</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
