                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Voir ma fiche de paie</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Ma fiche de paie</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Mon Nom</th>
                                                <th data-toggle="true">Mon matricule</th>
                                                <th data-hide="phone">Numéro de la fiche</th>
                                                <th data-hide="phone">Mon salaire</th>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="his_doc_view_single_payroll.php?pay_number=<?php echo $row->pay_number;?>" class="badge badge-success"><i class="fas fa-eye"></i> Voir fiche de paie</a>
