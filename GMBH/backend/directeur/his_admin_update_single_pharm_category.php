<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_pharmaceutical_category']))
		{
			...
			$query="UPDATE his_pharmaceuticals_categories SET dateinter=?  , code_équipement=?,  serv=? , descr=? , typeinter=? , typemaint=? , technicien=? , matricule=? WHERE nom_équipement= ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssssss',   $dateinter, $code_équipement , $serv , $descr , $typeinter , $typemaint , $technicien , $matricule  , $nom_équipement);
			$stmt->execute();
			/*
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                $nom_équipement=$_GET['nom_équipement'];
                $ret="SELECT  * FROM his_pharmaceuticals_categories WHERE nom_équipement=?";
