                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Les demandes d'interventions</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="his_admin_update_single_vendor.php?code_demande=<?php echo $row->code_demande;?>" class="badge badge-success"><i class="fas fa-edit"></i> Affecter</a>
