    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                ...
                $code=$_GET['code'];
                $ret="SELECT  * FROM his_medical_records WHERE code= ?";
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Pièce numèro :<?php echo $row->code;?></h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Code de la pièce : <?php echo $row->code;?></h2>
                                                    <hr>
                                                    <h3 class="text-danger">Nom de la pièce : <?php echo $row->nom;?> </h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Marque : <?php echo $row->marque;?></h3>
                                                    <hr>
