...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_pharmaceutical']))
		{
			...
			$query="INSERT INTO his_pharmaceuticals (code_équipement, nom_équipement, serviceinter, typeinter, dateinter , matrcicule ,nom) VALUES (?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssss', $code_équipement, $nom_équipement, $serviceinter, $typeinter, $dateinter , $matricule, $nom);
			$stmt->execute();
			/*
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" name="serviceinter" class="form-control"  id="inputPassword4">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Date de l'intervention</label>
                                                    <input required="required" type="date" name="dateinter" class="form-control"  id="inputPassword4">
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" name="matricule" class="form-control"  id="inputPassword4">
                                                    
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Nom du technicien</label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputState" class="col-form-label">Type de la maintenance préventive</label>
                                           ...
                                           <button type="submit" name="add_pharmaceutical" class="ladda-button btn btn-success" data-style="expand-right">Créer</button>
