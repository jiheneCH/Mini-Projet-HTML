                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Techniciens</a></li>
                                            <li class="breadcrumb-item active">Voir les techniciens</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Le profil de : <?php echo $row->doc_fname;?> <?php echo $row->doc_lname;?></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover mb-0">
                                        <thead class="thead-light">
                                            <tr>
                                                <th>Les interventions exécutées par ce technicien :</th>
