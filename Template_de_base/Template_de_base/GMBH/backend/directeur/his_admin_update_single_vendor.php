...
<?php
	...
	include('assets/inc/config.php');
		...
		{ 
			...
			$query="UPDATE his_vendor SET num=? , nom=?, etat=? WHERE code_demande=?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssss', $num , $nom , $etat ,$code_demande);
			$stmt->execute();
			/*
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputEmail4" class="col-form-label">Nom du technicien</label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Etape</label>
