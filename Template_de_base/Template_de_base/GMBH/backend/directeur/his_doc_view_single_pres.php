...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- ============================================================== -->
            <?php
                $code_rapport = $_GET['code_rapport'];
                
                $ret="SELECT  * FROM rapport WHERE code= '$code_rapport'";
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <h3 class="m-0 d-print-none">Rapport numéro<?php echo $row->code_demande;?></h3>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div>
                                            <p><strong>Code del'intervention : </strong><span class="float-right"><?php echo $row->code_demande;?></span></p>
