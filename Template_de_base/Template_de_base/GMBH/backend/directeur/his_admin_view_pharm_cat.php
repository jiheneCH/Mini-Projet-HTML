                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Interventions exécutées</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <td><?php echo $cnt;?></td>
                                                    ...
                                                    <td><a href="his_admin_view_single_pharm_category.php?id_intervention=<?php echo $row->id_intervention;?>" class="badge badge-success"><i class="mdi mdi-eye"></i>Voir</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
