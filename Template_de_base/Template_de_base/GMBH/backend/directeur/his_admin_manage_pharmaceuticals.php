<?php
  ...
  {
        $id=intval($_GET['id']);
        $adn="delete from his_pharmaceuticals where id=?";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Gérer le planning</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            <thead>
                                            <tr>
                                            <th data-toggle="true">Code de l'intervention</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <td><?php echo $row->id;?></td>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_view_single_pharm.php?id=<?php echo $row->id;?>" class="badge badge-success"><i class="far fa-eye "></i> Voir</a>
                                                        <a href="his_admin_update_single_pharm.php?id=<?php echo $row->id;?>" class="badge badge-warning"><i class="fas fa-clipboard-check "></i>Modifier</a>
                                                        <a href="his_admin_manage_pharmaceuticals.php?id=<?php echo $row->id;?>" class="badge badge-danger"><i class="fas fa-trash-alt"></i>Supprimer</a>
