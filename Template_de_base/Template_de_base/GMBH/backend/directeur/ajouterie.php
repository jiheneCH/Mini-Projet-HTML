...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_pharmaceutical_category']))
		{
			...
			$query="INSERT INTO intervention_externe (dateinter  , nom_équipement , code_équipement,  serv , descr , typeinter , typemaint , technicien , matricule , fournisseur) VALUES (?,?,?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssssssss', $dateinter , $nom_équipement, $code_équipement , $serv , $descr , $typeinter , $typemaint , $technicien , $matricule , $fournisseur);
			$stmt->execute();
			/*
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Nom de la société</label>
                                                    <input type="text" required="required" name="fournisseur" class="form-control" id="inputEmail4" >
                                                </div>
                                                <div class="form-group col-md-6">
