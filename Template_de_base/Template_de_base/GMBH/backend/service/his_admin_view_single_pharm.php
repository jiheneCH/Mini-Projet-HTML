                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Voir les interventions planifiées</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">L'intervention numéro :<?php echo $row->id;?> </h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                ...
                                                <h2 class="mb-3">Code de l'équipement : <?php echo $row->code_équipement;?></h2>
                                                    <hr>
                                                    <h2 class="mb-3">Nom de l'équipement : <?php echo $row->nom_équipement;?></h2>
                                                    <hr>
                                                    <h4 class="text-danger">Service : <?php echo $row->serviceinter;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Date de l'intervention: <?php echo $row->dateinter;?> </h4>
                                                    <hr>
                                                    <h4 class="text-danger">Type de l'intevention: <?php echo $row->typeinter;?> </h4>
                                                    <hr>
                                                    <h4 class="text-danger">Etape: <?php echo $row->etat;?> </h4>
                                                    <hr>
                                                    <h4 class="text-danger">Affectée à: <?php echo $row->nom;?> </h4>
                                                    <hr>
                                                    <h4 class="text-danger">Matricule du technicien: <?php echo $row->matricule;?> </h4>
                                                   <!--
