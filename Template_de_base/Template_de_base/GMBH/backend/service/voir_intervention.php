...
<?php include ('assets/inc/head.php');?>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                $id=$_GET['id'];
                $ret="SELECT  * FROM intervention_externe WHERE id = ?";
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Voir les interventions externes</li>
                                            </ol>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <hr>
                                                    <h3 class="text-danger">service : <?php echo $row->serv;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger">Date de l'intervention : <?php echo $row->dateinter;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger">Type d'intervention : <?php echo $row->typeinter;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger">Type de mainteance : <?php echo $row->typemaint;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger">Nom de la sociéte : <?php echo $row->fournisseur;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger">Nom et Prénom du technicien : <?php echo $row->technicien;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger">Matricule du technicien : <?php echo $row->matricule;?></h3>
                                                    <hr>
