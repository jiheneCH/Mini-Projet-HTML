                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Voir les interventions internes</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Les interventions internes</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <td><?php echo $cnt;?></td>
                                                    ...
                                                    <td><a href="his_admin_view_single_pharm_category.php?id_intervention=<?php echo $row->id_intervention;?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
