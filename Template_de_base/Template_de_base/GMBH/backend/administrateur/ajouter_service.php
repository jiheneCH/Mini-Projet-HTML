...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_doc']))
		{
			...
			$query="INSERT INTO his_service (ad_fname,  doc_number, ad_email, ad_pwd) values(?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssss', $ad_fname, $doc_number, $ad_email, $ad_pwd);
			$stmt->execute();
			/*
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Ajouter les détails du service</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Matricule du service</label>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input required="required" type="text" class="form-control" name="ad_email" id="inputAddress">
                                            </div>
                                                <div class="form-group col-md-6">
                                            ...
                                            <button type="submit" name="add_doc" class="ladda-button btn btn-success" data-style="expand-right">Ajouter le service</button>
