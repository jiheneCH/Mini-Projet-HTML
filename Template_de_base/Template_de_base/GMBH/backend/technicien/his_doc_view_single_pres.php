                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Nom du technicien  : <?php echo $row->nomtech;?></h2>
                                                    <hr>
                                                    <hr>
                                                    <h3 class="text-danger ">Date du rapport : <?php echo $row->date;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger">matricule du technicien : <?php echo $row->matr;?> Years</h3>
                                                    <hr>
                                                    ...
                                                    <hr>
                                                    <h3 class="text-danger ">Servide : <?php echo $row->services;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Type de maintenance : <?php echo $row->typemaint;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Type d'intervetion : <?php echo $row->typeinter;?></h3>
