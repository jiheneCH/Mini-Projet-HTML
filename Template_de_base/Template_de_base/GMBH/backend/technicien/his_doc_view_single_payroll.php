                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Fiche de paie</a></li>
                                                <
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Fiche de paie</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <h4 class="m-0 d-print-none"> La fiche de paie de :<?php echo $row->pay_doc_name;?> </h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 offset-md-2">
                                                <div class="mt-3 float-right">
                                                    <p class="m-b-10"><strong>Date : </strong> <span class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo date("d-m-Y - h:m:s", strtotime($mysqlDateTime));?> </span></p>
                                                    <p class="m-b-10"><strong>Statut : </strong> <span class="float-right"><span class="badge badge-success"><?php echo $row->pay_status;?></span></span></p>
                                                    <p class="m-b-10"><strong>Numero  : </strong> <span class="float-right"><?php echo $row->pay_number;?></span></p>
                                                    <p class="m-b-10"><strong>Matricule : </strong> <span class="float-right"><?php echo $row->pay_doc_number;?></span></p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="float-right">
                                                    <p><b>Sous_total:</b> <span class="float-right">$ <?php echo $row->pay_emp_salary;?></span></p>
